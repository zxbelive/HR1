						...
						<table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            %>
								...
								<%
									...
									String endtime = MTimeUtil.dateFormat(leave.getEndTime());
								%>
									<td><%=starttime %></td>
									<td><%=endtime %></td>
									<td><%=leave.getDays() %></td>
									...
									<td><a href="<%=path %>/leave/<%=leave.getId() %>/detail.do" class="btn btn-info">查看</a>&nbsp;&nbsp;
										<a href="<%=path %>/leave/<%=leave.getId() %>/update.do" class="btn btn-primary" id="suc">批准</a></td>
								</tr>
							<%
                           		 }
                             %>
