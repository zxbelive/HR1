		...
		<nav class="navbar-default navbar-static-side" role="navigation">
			...
			<div class="sidebar-collapse">
				<ul class="nav" id="side-menu">
							...
							<a data-toggle="dropdown" class="dropdown-toggle" href="#"> 
								<span class="clear"> 
									<span class="block m-t-xs" style="font-size: 20px;"> 
										...
										<strong class="font-bold">&nbsp;人事管理系统</strong>
									</span>
								</span>
							</a>
						</div>
					...
					<%--主页--%>
					<shiro:hasAnyRoles name="ADMIN,EMPLOYEE,MANAGE">
                   ...
                   <% Employee employee = (Employee)session.getAttribute("loged"); %>
					...
					<shiro:hasAnyRoles name="EMPLOYEE,MANAGE">
					<li><a href="graph_metrics.html">
						<i class="fa fa fa-newspaper-o"></i>
						<span class="nav-label">个人信息</span>
						<span class="fa arrow"></span>
                    ...
                    <shiro:hasRole name="ADMIN">
                        <li><a href="mailbox.html">
                            <i class="fa fa-calendar"></i>
                            <span class="nav-label">加班管理</span>
                            <span class="fa arrow"></span>
                        </a>
                            <ul class="nav nav-second-level">
					...
					<li><a href="mailbox.html">
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="<%=path %>/salary/to.do?pageNo=1">员工薪资管理</a>
							</li>
							<%--<li><a class="J_menuItem" href="<%=path %>/salary/to.do">个人薪资</a>--%>
							<%--</li>--%>
						</ul></li>
					</shiro:hasRole>
					...
					<li>
						<a href="#">
							...
							<span class="nav-label">&nbsp;ECharts图</span>
							<span class="fa arrow"></span>
						</a>
					<ul class="nav nav-second-level">
						<li><a class="J_menuItem" href="<%=path %>/echarts/to.do">男女、工资人数比例图</a>
						</li>
						<li><a class="J_menuItem" href="<%=path %>/echarts/to1.do">考勤、在职状态人数图</a>
						</li>
					</ul>
					</li>
					</shiro:hasAnyRoles>
