...
<body class="gray-bg">
				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<div style="margin-bottom: 8px">
							...
							<a href="<%=path %>/overtime/<%=depnum%>/toAdd.do" class="btn btn-success">安排加班</a>
						</div>
						</shiro:hasAnyRoles>
							...
							<nav aria-label="Page navigation" style="margin: 0 auto; width: 240px">
								<ul class="pagination" style="margin: 0;">
									<li>
										...
										<a href="<%=path %>/overtime/<%=employee.getEmployeeNumber()%>/listPage.do?pageNo=<%=pe.getCurrent()-1>1?pe.getCurrent()-1:1 %>"
								...
								%>
									<li><a href="<%=path %>/overtime/<%=employee.getEmployeeNumber()%>/listPage.do?pageNo=<%=i%>"><%=i %></a></li>
								<%
	 								 }
								%>
									<li><a href="<%=path %>/overtime/<%=employee.getEmployeeNumber()%>/listPage.do?pageNo=<%=pe.getCurrent()+1<pe.getPages()?pe.getCurrent()+1:pe.getPages() %>"
	...
	function del(id){
		parent.layer.confirm('确认删除？', {
		    ...
		    location.href="/overtime"+"/"+ id +"/delete.do";
		});
	}
	</script>
</body>
